<nav class="bg-gray-800 sticky top-0" x-data="{open:false}">{{-- "sticky top-0" para que se quede fijo. Referencia: https://tailwindcss.com/docs/position --}}
        ...
        <div class="relative flex items-center justify-between h-16">
            ...
            <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                <a href="{{ route('posts.index') }}" class="flex-shrink-0 flex items-center">
                    ...
                    <img class="block lg:hidden h-8 w-auto" src="{{ asset('imagenes/workflow-mark-indigo-500.svg',true) }}" alt="Logo convocatorias">
                    {{--<img class="hidden lg:block h-8 w-auto" src="https://tailwindui.com/img/logos/workflow-logo-indigo-500-mark-white-text.svg" alt="Workflow">--}}
                    <img class="hidden lg:block h-8 w-auto" src="{{ asset('imagenes/convocatorias-logo-indigo-500-mark-white-text.svg',true) }}" alt="Logo convocatorias">
            ...
            @auth
                <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                    ...
                    {{--<!-- Profile dropdown -->: Con "x-data" Alpine considera lo que engloba la etiqueta en cuestión como un componente--}}
    ...
    <!--
      ...
      Menu open: "block", Menu closed: "hidden"
    -->
    <div class="sm:hidden" x-show="open" x-on:click.away="open=false">{{--Quitamos "hidden" https://youtu.be/WSA37Ui0b6Q?t=525--}}
